  ...
  return (
    <MainContent>
      <Routes>
        ...
        <Route path="/profile" element={logRegisterContext.token ? <ProfilePage /> : <Navigate to="/auth" />} />
        <Route path="/help" element={logRegisterContext.token ? <HelpPage /> : <Navigate to="/auth" />} />
        ...
        <Route path="/my-trips" element={logRegisterContext.token ? <MyTripsPage /> : <Navigate to="/auth" />} />
